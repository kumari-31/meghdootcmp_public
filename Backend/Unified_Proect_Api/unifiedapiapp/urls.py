...
urlpatterns = [
    ...
    path('api/combined-form/', CombinedFormView.as_view(), name='combined-form'),
    ...
    path('api/images/', ListImages.as_view(), name='list_images'),
     # path('api/image/create-image/', OpenStackImageCreateView.as_view(), name='create-image'), will work well
    ...
    # path('api/networks/create/',CreateNetworkAPIView.as_view(), name='create_network'),
    ...
    path('api/combined-data/', CombinedView.as_view(), name='combined-data'),
    # path('api/create-host/', views.create_host, name='create-host'),
    ...
    # path('api/overview/hypervisors/', HypervisorViewSet.as_view(), name='openstack_overview'),
    path('api/project-usage/', ProjectUsageAPIView.as_view(), name='project-usage'),
    path('api/hypervisors/dashboard/', HypervisorDataAPIView.as_view(), name='hypervisor-dashboard'),
    ...
    path('api/instances-details/', InstanceDetailsAPIViewDetails.as_view(), name='instance-details'), 
    path('api/vm-detail/', VMDetailAPIView.as_view(), name='vm-detail'),
    path('api/vm_action/', VMActionAPIView.as_view(), name='vm_action'),
    # path('api/images/create/', CreateImageAPIView.as_view(), name='create_image'),
    path('api/create-snapshot/', CreateSnapshotAPIView.as_view(), name='create-snapshot'),
    ...
    path('api/volumes/', ListVolumesAPIView.as_view(), name='list_volumes'),
    ...
    # path('api/vmrequests/', VmRequestAPIViewAdmin.as_view(), name='vm_requests'),
    ...
    # path('api/vmrequest/<int:id>/', vm_approve_request, name='vm_request'),
    ...
    # path('api/vmrequests/approved-vms/', ApprovedVMsAPIView.as_view(), name='approved-vms'),
    path('api/vmrequests/approved-vms/user/', ApprovedVMsAPIView.as_view(), name='approved-vms'),
    path('api/vm-request/reject/', VmRequestRejectionReasonAPIView.as_view(), name='approved-vms'),
    ...
    path('api/cpu-utilization/<int:host_id>/', CPUUtilizationView.as_view(), name='cpu-utilization'),
    
    path('api/openstack/servicemonitor/', ServiceMonitorView.as_view(), name='openstack-services-monitor'),
    path('api/list-nodes-vms/', ListNodesAndVMsAPIView.as_view(), name='list-nodes-vms'),
    ...
    # path("api/k8s/node-details/", views.get_k8s_nodes, name="detail_k8s_nodes"),
    # path('api/k8s/node-details/', views.get_node_details1, name='get_node_details'),
    
    # path("api/k8s/pods/", ListK8sPods.as_view(), name="list_k8s_pods"),
    ...
    # path("api/k8s/deploy-application/", DeployApplicationAPIView.as_view(), name="deploy-application-pod"),
    # path("api/k8s/deploy-pod/", DeployPodAPIView.as_view(), name="deploy-pod"),
    path('api/k8s/deploy-pod/', DeployPodOnKnode2APIView.as_view(), name='deploy-pod-knode2'),
    path("api/k8s/delete-pod/", DeletePodAPIView.as_view(), name="delete-pod"),
    ...
    path("api/infrastructure/host-aggregates/", HostAggregateAPIView.as_view(), name="host_aggregates_list"),               # GET list, POST create
    path("api/infrastructure/host-aggregates/<str:aggregate_id>/", HostAggregateAPIView.as_view(), name="host_aggregate_detail"),  # GET, PUT, DELETE
    path("api/infrastructure/host-aggregates/<str:aggregate_id>/actions/", HostAggregateActionsView.as_view(), name="host_aggregate_actions"),  # Add/remove hosts
