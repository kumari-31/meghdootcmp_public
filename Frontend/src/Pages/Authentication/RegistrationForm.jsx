...
function RegistrationForm() {
    ...
    const validateForm = () => {
        ...
        if (!fullName || !organization || !designation || !email || !phone || !password || !confirmPassword || !employeeId) {
    ...
    const handleRegistration = async (e) => {
        ...
        // Now check if user has opened the terms dialog
        ...
        <div className="registration-page">
            <div className="registration-container">
                <div className="text-side">
                    <h1>Register for<br /><span style={{ color: 'hsl(218, 81%, 75%)' }}> Meghdoot Cloud </span></h1>
  ...
  <div className="terms-and-conditions">
    ...
    <FormControlLabel
      control={<Checkbox checked={termsAgreedInPopup} onChange={handleTermsAgreedChange} />}
  ...
  <div className="signup-link">
    Already have an account? <Link to="/">Login</Link>
            ...
            <Dialog open={termsDialogOpen} onClose={handleCloseTermsDialog}>
                ...
                <DialogContent>
                    <Typography paragraph>
                        These terms and conditions ("Terms") govern your use of Meghdoot Cloud.
                    </Typography>
                    <Typography paragraph>
                        1. **Account:** You are responsible for maintaining the security of your account credentials.
                    </Typography>
                    <Typography paragraph>
                        2. **Use:** You agree to use our services for lawful purposes only and not to engage in any prohibited activities.
                    </Typography>
                    <Typography paragraph>
                        3. **Data:** You retain ownership of your data. By using our services, you grant us a limited license to process your data solely for the purpose of providing the service.
                    </Typography>
                </DialogContent>
                <DialogActions>
            ...
            {/* Reminder Dialog */}
            <Dialog open={showTermsReminderDialog} onClose={() => setShowTermsReminderDialog(false)}>
                <DialogTitle>Action Required</DialogTitle>
                <DialogContent>
                    <Typography>Please click "View Terms and Conditions" and agree before registering.</Typography>
                </DialogContent>
                <DialogActions>
            ...
            <Dialog open={showSuccessDialog} onClose={() => {
                ...
                <DialogContent>
                    <Typography>Your account has been registered successfully. You can now log in.</Typography>
                </DialogContent>
                <DialogActions>
                    <Button onClick={() => {
                        setShowSuccessDialog(false);
